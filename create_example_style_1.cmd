...
echo --- "create_chord_map.py" analyses the songs in a directory to create chord data files --- 
create_chord_map.py -m input/music/placeholder_chords/example_style_1/ -o input/style/example_style_1/
